...
module Flame (flame) where

import Text.Hamlet (shamlet, Html)
import Text.Blaze.Html.Renderer.String (renderHtml)

flame :: String
flame = renderHtml html
  ...
  <html lang="ja">
    ...
    <body class="container">
      ...
      <main>
        \$body$
      <!-- End Document -->
      <footer>Site proudly generated by 
        <a href="http://jaspervdj.be/hakyll">Hakyll<br />
        hosted on 
        <a href="https://github.io">Github<br />
        The source code of this website is available at 
        <a href="https://github.com/eliza0x/eliza0x.github.io">github
  |]
