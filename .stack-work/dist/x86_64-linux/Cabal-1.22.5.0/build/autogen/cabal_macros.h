...
/* package hakyll-4.8.3.1 */
#define VERSION_hakyll "4.8.3.1"
#define MIN_VERSION_hakyll(major1,major2,minor) (\
  (major1) <  4 || \
  (major1) == 4 && (major2) <  8 || \
  (major1) == 4 && (major2) == 8 && (minor) <= 3)

/* package hakyll-sass-0.2.0 */
#define VERSION_hakyll_sass "0.2.0"
...
#define CURRENT_PACKAGE_KEY "blog_LKMYbBL5F8ZLQQsZwNpdTE"
