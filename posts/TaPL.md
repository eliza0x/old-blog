...
TaPLでの読書メモが書いてあります。真偽の保証はできません。必要に応じて追記していきます。
...
- 型付きラムダ計算は$\lambda _\rightarrow$と表記される
- 導入規則
	+ その型の要素がどのように作られるか
- 除去規則
	+ その型の要素がどのように使われるか
- 論理学と型理論のふしぎな関連はCurry-Howard対応^[Curry-Howard同系ともよばれる]として知られている
...
https://kagamilove0707.github.io/programming/2014/02/20/about-phantom-type/)が面白い
